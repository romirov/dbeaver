...
public class DataExporterXLSX extends StreamExporterAbstract {
    ...
    public static Map<String, Object> getDefaultProperties() {
        ...
        properties.put(DataExporterXLSX.PROP_HEADER_FONT, "Arial");
        properties.put(DataExporterXLSX.PROP_HEADER_FONT_STYLE, "BOLD");
    ...
    public void init(IStreamDataExporterSite site) throws DBException {
        ...
        try {
            ...
            fontStyle = FontStyleProp.valueOf(CommonUtils.toString(properties.get(PROP_HEADER_FONT_STYLE), FontStyleProp.BOLD.name()));
